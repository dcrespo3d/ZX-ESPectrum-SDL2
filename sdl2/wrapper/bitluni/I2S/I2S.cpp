...
static void esp_intr_enable(void*) {}
static void esp_intr_disable(void*) {}

static i2s_dev_t I2S0;
static i2s_dev_t I2S1;
...
void I2S::reset()
{
    ...
    const unsigned long lc_conf_reset_flags = 0; // I2S_IN_RST_M | I2S_OUT_RST_M | I2S_AHBM_RST_M | I2S_AHBM_FIFO_RST_M;
	i2s.lc_conf.val |= lc_conf_reset_flags;
	i2s.lc_conf.val &= ~lc_conf_reset_flags;

	const uint32_t conf_reset_flags = 0; // I2S_RX_RESET_M | I2S_RX_FIFO_RESET_M | I2S_TX_RESET_M | I2S_TX_FIFO_RESET_M;
